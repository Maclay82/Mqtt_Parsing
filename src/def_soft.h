...
#define DEFAULT_MQTT_SERVER   "192.168.2.175" //"192.168.1.166" //"192.168.2.182"// MQTT сервер
#endif

#ifndef DEFAULT_MQTT_USER
#define DEFAULT_MQTT_USER   "user"//"openhabian"//      // Имя mqtt-пользователя    (укажите имя пользователя для вашего соединения)
#endif

#ifndef DEFAULT_MQTT_PASS
#define DEFAULT_MQTT_PASS   "DINH6J6T"//"openhabian"//   // Пароль mqtt-пользователя (укажите пароль вашего соединения)
#endif
